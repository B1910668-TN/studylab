...
<body>
    ...
    <!-- If no login -->        
                <?php
                            ...
                            require 'php/connect-select-db.php';
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="#" class="nav-link">You</a></li>
                </ul>
            </div>
        </div>
    </nav>
                        ...
                        <h3 class="mb-4">Register Now</h3>
                            <form action="php/signup.php" method="POST" class="signup-form">
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" type="text" name="fullname" class="form-control" required placeholder="Mean Ping">
                                </div>
                                <div class="form-group">
                                    <label class="label" for="email">Email Address</label>
                                    <input autocomplete="off" type="email" name="email" class="form-control" required placeholder="meanping@gmail.com">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="cfpass" class="form-control" required placeholder="Confirm password">
                                </div>
    ...
    <!-- If login-->
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="blog.html" class="nav-link">Blog</a></li>
                    <li class="nav-item"><a href="contact.html" class="nav-link">Contact</a></li>
                    <li class="nav-item"><a href="php/signout.php" class="nav-link">Sign out</a></li>
                </ul>
            </div>
        </div>
    </nav>
